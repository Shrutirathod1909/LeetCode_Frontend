...
function Admin() {
  ...
  const adminOptions = [
    ...
    },
    {
      ...
      description: 'Upload and manage problem solution videos',
      icon: Video,
      color: 'btn-success',
      bgColor: 'bg-success/10',
      route: '/admin/video'
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {adminOptions.map((option) => {
            ...
            return (
              <div key={option.id} className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
